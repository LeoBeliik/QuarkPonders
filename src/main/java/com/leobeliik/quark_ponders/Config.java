...
public class Config {
    ...
    private static ForgeConfigSpec.Builder COMMENT_BUILDER = new ForgeConfigSpec.Builder();
    private static ForgeConfigSpec.Builder CLIENT_BUILDER = new ForgeConfigSpec.Builder();

    //automation
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> chainConnectBlocks_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> chute_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> dispenser_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> enderWatcher_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> feedingTrough_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> gravisand_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> ironRod_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> metalButtons_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> obsidianPressurePlate_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> pistonsMoveTE_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> redstoneRandomizer_module;

    //building
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> glassItemFrames_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> grate_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> rope_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> stools_module;

    //Mobs
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> oretoise_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> foxhound_module;

    //Tools
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> skullPikes_module;

    //Tweaks
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> enhancedLadders_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> replaceScaffolding_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> slimeToMagma_module;

    //Oddities
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> pipes_module;
    public static ForgeConfigSpec.ConfigValue<List<? extends String>> magnet_module;
    ...
    private static void Automation() {
        CLIENT_BUILDER.comment("You can set what items are used to ponder each scene in the mod",
                ...
                "\nAutomation module settings").push("Automation");
